...
<div><br/>
	 <div class="CLS_mainContentDivHegiht">
	     ...
	     <input id="Id_dataCollectParamsIP" size="10"/>
	     <label for="name" style="width: 50px">端口:</label>
	     <input id="Id_dataCollectParamsPORT" size="4"/>
     </div>
	 <div class="CLS_mainContentDivHegiht">
        <label for="name" class="data_label_width">网址:</label>
        <input id="Id_dataCollectParamsbaseURL" size=48/>
     </div>
     <div class="CLS_mainContentDivHegiht">
		<label for="name" class="data_label_width">分页参数:</label>
	    <input id="Id_dataCollectParamspageParams" size=6/>
	    <label for="name" style="width: 50px">开始:</label>
	    <input id="Id_dataCollectParamsstart" size=6/>
	    <label for="name" style="width: 50px">结束:</label>
	    <input id="Id_dataCollectParamsend" size=6/>
	    <label for="name" style="width: 50px">步长:</label>
	    <input id="Id_dataCollectParamsstep" size=6/>
    </div>
     <div class="CLS_mainContentDivHegiht">
        <label for="name" class="data_label_width">基本选择器:</label>
        <input id="Id_dataCollectParamsbaseSelect" size=49/>
     </div>
      <div class="CLS_mainContentDivHegiht">
        ...
        <input id="Id_dataCollectParamstableName" size=17/>
     </div>
