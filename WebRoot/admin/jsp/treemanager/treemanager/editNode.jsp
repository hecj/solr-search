...
<script type="text/javascript">
	var submitForm = function(dialog,parentGrid){
		...
		//sumbit
	    $('form').form('submit', {
	    	url : app.basePath+'admin/tree/menuTree.htm?operator=editNodeSumbit',
	...
	<div>
		<form method="post">
			 <div style="margin-top: 20px">
			     ...
			     <input name="name" size="30" value="${module.name }" class="easyui-validatebox" data-options="required:true,validType:'notEmpty'"/>
		     </div>
		     <div>
